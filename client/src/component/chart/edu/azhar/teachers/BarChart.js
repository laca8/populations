...
const ChartBar = ({ data1 }) => {
  // console.log(data1);
  let arr1 = data1.filter((c) => c._id.residence == "حضر");
  let arr2 = data1.filter((c) => c._id.residence == "ريف");
  let arr15 = arr1
    .filter((c) => c._id.العام == 2015)
    .reduce((acc, val) => acc + val.total_teachers, 0);
  ...
  let arrUrban = [arr15, arr16, arr17, arr18, arr19, arr20, arr21];
  let arrRural = [arrR15, arrR16, arrR17, arrR18, arrR19, arrR20, arrR21];
  const options = {
    responsive: true,
