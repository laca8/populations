...
import { classesIndMid } from "../../../../redux/actions/educationsAction/education";
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of schools in industrial education in {city}
