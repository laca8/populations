...
import { schoolCommercial } from "../../../../redux/actions/educationsAction/education";
import {
  Form,
  Button,
  Container,
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of schools in commercial education in egypt
