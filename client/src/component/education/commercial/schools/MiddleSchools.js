...
import { schoolCommercialMid } from "../../../../redux/actions/educationsAction/education";
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(schoolCommercialMid(city));
  }, [city]);
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            {" "}
            The total number of schools in commercial education in {city}
