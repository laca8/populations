...
import { classesAgriMid } from "../../../../redux/actions/educationsAction/education";
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of classes in agriculture education in {city}
