...
import { schoolSecondaryMid } from "../../../../redux/actions/educationsAction/education";
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(schoolSecondaryMid(city));
  }, [city]);
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of schools in secondary education in {city}
