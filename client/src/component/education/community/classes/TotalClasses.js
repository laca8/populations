...
import { classesCommunity } from "../../../../redux/actions/educationsAction/education";
import {
  Form,
  Button,
  Container,
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of classes in community education in egypt
