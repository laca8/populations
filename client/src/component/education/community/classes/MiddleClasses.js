...
import { classesCommunityMid } from "../../../../redux/actions/educationsAction/education";
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(classesCommunityMid(city));
  }, [city]);
      ...
      {loading ? (
        ...
        <>
          <Typography variant="h4">
            The total number of classes in cmmunity education in {city}
