...
import { schoolCommunityMid } from "../../../../redux/actions/educationsAction/education";
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(schoolCommunityMid(city));
  }, [city]);
      ...
      {loading ? (
        ...
        <>
          <Typography variant="h4">
            The total number of schools in community education in {city}
