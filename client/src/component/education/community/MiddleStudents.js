...
import { studentsMidCommunity } from "../../../redux/actions/educationsAction/education";
import {
  Form,
  Button,
  Container,
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(studentsMidCommunity(city));
  }, [city]);
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of students in community education in {city}
