...
import { schoolPrimaryMid } from "../../../../redux/actions/educationsAction/education";
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(schoolPrimaryMid(city));
  }, [city]);
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of schools in primary education in {city}
