...
import { studentsPrimary } from "../../../redux/actions/educationsAction/education";
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of students in primary education in egypt
