...
import { classesSpecialMid } from "../../../../redux/actions/educationsAction/education";
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(classesSpecialMid(city));
  }, [city]);
  ...
  return (
    <div>
      {loading ? (
        ...
        <>
          <Typography variant="h4">Total Classes Of {city}</Typography>
