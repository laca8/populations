...
import { schoolSpecialMid } from "../../../../redux/actions/educationsAction/education";
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(schoolSpecialMid(city));
  }, [city]);
      ...
      {loading ? (
        ...
        <>
          <Typography variant="h4">
            The total number of schools in special education in {city}
