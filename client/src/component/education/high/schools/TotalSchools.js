...
import { schoolHigh } from "../../../../redux/actions/educationsAction/education";
import {
  Form,
  Button,
  Container,
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of schools in high school in egypt
            2017,2018,2019,2020,2021,2022 with division by sex and residence and
            dependency
          </Typography>
          <Table
            striped
            ...
            <tbody>
              {data.map((pop, index) => (
                <tr key={index}>
                  ...
                  <td>{pop?.total_schools?.toLocaleString()}</td>
                </tr>
              ))}
            </tbody>
          </Table>
