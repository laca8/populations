...
import { studentsMidPrePrimary } from "../../../redux/actions/educationsAction/education";
import {
  Form,
  Button,
  Container,
...
import ChartLine from "../../chart/edu/prepreimary/middleStu/Line";
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(studentsMidPrePrimary(city));
  }, [city]);
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of students in pre-primary education in {city}
