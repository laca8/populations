...
import { schoolPrePrimary } from "../../../../redux/actions/educationsAction/education";
import {
  Form,
  Button,
  Container,
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of schools in pre-primary education in egypt
