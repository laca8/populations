...
import { classesPrePrimaryMid } from "../../../../redux/actions/educationsAction/education";
...
const MiddleStudents = ({ city }) => {
  ...
  useEffect(() => {
    dispatch(classesPrePrimaryMid(city));
  }, [city]);
      ...
      {loading ? (
        ...
        <>
          <Typography variant="p">
            The total number of classes in pre-primary education in {city}
