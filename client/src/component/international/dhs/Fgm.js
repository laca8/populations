...
const Fgm = () => {
  const internationalDhsFgmReducer = useSelector(
    (state) => state.internationalDhsFgmReducer
  );
  const { data, error, loading } = internationalDhsFgmReducer;
  ...
  const addInternationalDhsFgmReducer = useSelector(
    (state) => state.addInternationalDhsFgmReducer
  );
  const {
    loading: loadingAdd,
    error: errorAdd,
