...
const Child = () => {
  const internationalDhsChildReducer = useSelector(
    (state) => state.internationalDhsChildReducer
  );
  const { data, error, loading } = internationalDhsChildReducer;
  ...
  const addInternationalDhsChildReducer = useSelector(
    (state) => state.addInternationalDhsChildReducer
  );
  const {
    loading: loadingAdd,
    error: errorAdd,
