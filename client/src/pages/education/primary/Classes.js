...
import TotalClasses from "../../../component/education/primary/classes/TotalClasses";
import MiddleClasses from "../../../component/education/primary/classes/MiddleClasses";
...
import { addClassesPrimaryAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addClassesPrimaryAction(data));
    setJson("");
  };
