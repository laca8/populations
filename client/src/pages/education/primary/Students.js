...
import TotalStudents from "../../../component/education/primary/TotalStudents";
import MiddleStudents from "../../../component/education/primary/MiddleStudents";
...
const Students = () => {
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addStudentsPrimaryAction(data));
    setJson("");
