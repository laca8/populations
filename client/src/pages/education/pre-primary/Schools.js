...
import TotalSchools from "../../../component/education/pre-primary/schools/TotalSchools";
import MiddleSchools from "../../../component/education/pre-primary/schools/MiddleSchools";
...
import { addSchoolPreprimaryAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addSchoolPreprimaryAction(data));
    setJson("");
  };
