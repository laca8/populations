...
import TotalClasses from "../../../component/education/pre-primary/classes/TotalClasses";
import MiddleClasses from "../../../component/education/pre-primary/classes/MiddleClasses";
...
const Classes = () => {
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addClassesPreprimaryAction(data));
    setJson("");
  };
