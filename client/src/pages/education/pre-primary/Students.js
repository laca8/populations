...
import TotalStudents from "../../../component/education/pre-primary/TotalStudents";
import MiddleStudents from "../../../component/education/pre-primary/MiddleStudents";
...
import { addStudentsPreprimaryAction } from "../../../redux/actions/educationsAction/education";
const Students = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addStudentsPreprimaryAction(data));
    setJson("");
