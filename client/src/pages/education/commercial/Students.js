...
import TotalStudents from "../../../component/education/commercial/TotalStudents";
import MiddleStudents from "../../../component/education/commercial/MiddleStudents";
...
import { addStudentsCommAction } from "../../../redux/actions/educationsAction/education";
const Students = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addStudentsCommAction(data));
    setJson("");
