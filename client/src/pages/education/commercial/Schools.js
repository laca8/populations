...
import TotalSchools from "../../../component/education/commercial/schools/TotalSchools";
import MiddleSchools from "../../../component/education/commercial/schools/MiddleSchools";
...
import { addSchoolCommAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addSchoolCommAction(data));
    setJson("");
  };
