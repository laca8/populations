...
import TotalStudents from "../../../component/education/community/TotalStudents";
import MiddleStudents from "../../../component/education/community/MiddleStudents";
...
import { addStudentsCommunityAction } from "../../../redux/actions/educationsAction/education";
const Students = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addStudentsCommunityAction(data));
    setJson("");
