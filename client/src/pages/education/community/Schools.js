...
import TotalSchools from "../../../component/education/private/schools/TotalSchools";
import MiddleSchools from "../../../component/education/private/schools/MiddleSchools";
...
import { addSchoolCommunityAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addSchoolCommunityAction(data));
    setJson("");
  };
