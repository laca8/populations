...
import TotalStudents from "../../../component/education/industrial/TotalStudents";
import MiddleStudents from "../../../component/education/industrial/MiddleStudents";
...
import { addStudentsIndAction } from "../../../redux/actions/educationsAction/education";
const Students = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addStudentsIndAction(data));
    setJson("");
