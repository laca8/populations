...
import TotalSchools from "../../../component/education/industrial/schools/TotalSchools";
import MiddleSchools from "../../../component/education/industrial/schools/MiddleSchools";
...
import { addSchoolIndAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addSchoolIndAction(data));
    setJson("");
  };
