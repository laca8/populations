...
import TotalSchools from "../../../component/education/hotel/schools/TotalSchools";
import MiddleSchools from "../../../component/education/hotel/schools/MiddleSchools";
...
import { addSchoolHotelAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addSchoolHotelAction(data));
    setJson("");
  };
