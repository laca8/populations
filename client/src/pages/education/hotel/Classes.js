...
import TotalClasses from "../../../component/education/hotel/classes/TotalClasses";
import MiddleClasses from "../../../component/education/hotel/classes/MiddleClasses";
...
import { addClassesHotelAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addClassesHotelAction(data));
    setJson("");
  };
