...
import TotalClasses from "../../../component/education/private/classes/TotalClasses";
import MiddleClasses from "../../../component/education/private/classes/MiddleClasses";
...
import { addClassesPrivateAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addClassesPrivateAction(data));
    setJson("");
  };
