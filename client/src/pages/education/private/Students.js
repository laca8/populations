...
import TotalStudents from "../../../component/education/private/TotalStudents";
import MiddleStudents from "../../../component/education/private/MiddleStudents";
...
import { addStudentsPrivateAction } from "../../../redux/actions/educationsAction/education";
const Students = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addStudentsPrivateAction(data));
    setJson("");
