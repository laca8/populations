...
import TotalClasses from "../../../component/education/high/classes/TotalClasses";
import MiddleClasses from "../../../component/education/high/classes/MiddleClasses";
...
import { addClassesHighAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addClassesHighAction(data));
    setJson("");
  };
