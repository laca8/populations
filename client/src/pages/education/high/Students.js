...
import TotalStudents from "../../../component/education/high/TotalStudents";
import MiddleStudents from "../../../component/education/high/MiddleStudents";
...
import { addStudentsHighAction } from "../../../redux/actions/educationsAction/education";
const Students = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addStudentsHighAction(data));
    setJson("");
