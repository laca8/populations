...
import TotalClasses from "../../../component/education/arg/classes/TotalClasses";
import MiddleClasses from "../../../component/education/arg/classes/MiddleClasses";
...
import { addClassesAgriAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addClassesAgriAction(data));
    setJson("");
  };
