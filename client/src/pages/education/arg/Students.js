...
import TotalStudents from "../../../component/education/arg/TotalStudents";
import MiddleStudents from "../../../component/education/arg/MiddleStudents";
...
const Students = () => {
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addStudentsAgriAction(data));
    setJson("");
