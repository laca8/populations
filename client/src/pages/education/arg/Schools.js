...
import TotalSchools from "../../../component/education/arg/schools/TotalSchools";
import MiddleSchools from "../../../component/education/arg/schools/MiddleSchools";
...
import { addSchoolAgriAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addSchoolAgriAction(data));
    setJson("");
  };
