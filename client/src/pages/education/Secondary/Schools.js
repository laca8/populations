...
import TotalSchools from "../../../component/education/secondary/schools/TotalSchools";
import MiddleSchools from "../../../component/education/secondary/schools/MiddleSchools";
...
import { addSchoolSecondaryAction } from "../../../redux/actions/educationsAction/education";
const Classes = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addSchoolSecondaryAction(data));
    setJson("");
  };
