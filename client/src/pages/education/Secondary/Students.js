...
import TotalStudents from "../../../component/education/secondary/TotalStudents";
import MiddleStudents from "../../../component/education/secondary/MiddleStudents";
...
import { addStudentsSecondaryAction } from "../../../redux/actions/educationsAction/education";
const Students = () => {
  const cities = [
    "القاهرة",
    "الجيزة",
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addStudentsSecondaryAction(data));
    setJson("");
