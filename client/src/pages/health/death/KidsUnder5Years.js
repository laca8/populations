...
import {
  listDeathKidsUnder5years,
  addDeathKidsUnder5years,
...
const KidsUnder5Years = () => {
  ...
  useEffect(() => {
    dispatch(listDeathKidsUnder5years());
  }, []);
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addDeathKidsUnder5years(data));
    setJson("");
  };
      ...
      {loading ? (
        ...
        <>
          ...
          <div
            ...
            style={{ height: 500, fontSize: "30px", textAlign: "center" }}
          >
            <AgGridReact
              rowData={data1}
...
export default KidsUnder5Years;
