...
import {
  listDeathKidsUnder28days,
  addDeathKidsUnder28days,
...
const KidsUnder28Days = () => {
  ...
  useEffect(() => {
    dispatch(listDeathKidsUnder28days());
  }, []);
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addDeathKidsUnder28days(data));
    setJson("");
  };
...
export default KidsUnder28Days;
