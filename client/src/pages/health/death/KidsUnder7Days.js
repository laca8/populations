...
import {
  listDeathKidsUnder7days,
  addDeathKidsUnder7days,
...
const KidsUnder7Days = () => {
  ...
  useEffect(() => {
    dispatch(listDeathKidsUnder7days());
  }, []);
  ...
  const handleSubmit = async () => {
    ...
    dispatch(addDeathKidsUnder7days(data));
    setJson("");
  };
